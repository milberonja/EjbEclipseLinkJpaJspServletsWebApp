...
public class FlightService {
	...
	public void addFlight(Flight f, Airplane a) {
		em.persist(f);
		//em.persist(a); -- From reason of Cascade propagation this line of code doesn't have to be writen
	}
	
	public void addPilotToFlight(String flightId, String pilotId) {
